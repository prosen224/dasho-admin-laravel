...
<div class="container-fluid bg-dark" style="min-height: 100vh;">
    <div class="auth-wrapper" style="min-height: 55vh;padding-top: 11vh;">
        <div class="row bg-white">

            <div class="text-center col-sm-12 mt-5">
                <img src="{{asset('assets/images/logo/patshala.png')}}" width="150" class="img-fluid mb-4" alt="User-Profile-Image">
            </div>
                        ...
                        <form id="user_login_form" >
                            @csrf
                             <div class="form-group">
                                <input placeholder="{{__('E-mail')}}" type="email" class="form-control bg-light" name="email" >
                                <span class="text-danger error_email d-flex"></span>
                            </div>
                            ...
                            <div class="login-btn">
                            <button type="submit" class="btn btn-danger btn-block mb-4 text-uppercase font-weight-bold" id="user_login_btn">{{__('Login')}}</button>
                            </div>
                        </form>
...
var login_btn = `<button type="button" class="btn btn-danger btn-block mb-4 text-uppercase font-weight-bold" id="user_login_btn">{{__('Login')}}</button>`;
$(document).on({
