@extends('Frontend.mainlayout',['title'=>'Update ranks'])
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="dt-responsive">
                    <form method="POST" action="{{route('ranks.update', $item->id)}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-2">
                                ...
                                @if ($item->image && file_exists(public_path('uploads/ranks/'.$item->image)))
                                    <img width="100" style="" src="{{asset('uploads/ranks/'.$item->image)}}">
                                @endif
                            </div>
