@extends('Frontend.mainlayout',['title'=>'Create richtext'])
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="dt-responsive">
                    <form method="POST" action="{{route('richtext.update', $item->id)}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sub_title" value="{{$item->sub_title}}" class="form-control" id="2" aria-describedby="emailHelp">
                            @error('sub_title')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
