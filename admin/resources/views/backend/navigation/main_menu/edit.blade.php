@extends('Frontend.mainlayout',['title'=>'Update main menu'])
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                ...
                <a class="btn btn-sm btn-dark float-right" href="{{route('navigation.index')}}">Back</a>
            </div>

            <div class="card-body">
                <div class="dt-responsive">
                    <form method="POST" action="{{route('navigation.update', encrypt($navigation->id))}}" enctype="multipart/form-data">
                        @csrf
