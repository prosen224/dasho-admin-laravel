...
<div class="container-fluid">
    ...
    <div class="row" style="padding-top:10px;background-color: #fa8100;">
        <div class="col-md-12 col-xs-12">
            <p style="font-weight:bold;text-align:center;"><span style="color:white;padding:15px;font-size:20px;">Higher Education Certificate</span></p>
        </div>
    </div>
    ...
    <div class="col-md-4 col-xs-6">
       <p style="color:red;font-weight:bold;font-size:16px;">Board:: #<?php echo $common_result[0]['board_status'];?></p>
        <p style="font-weight:bold;font-size:16px;"><span style="background-color: #fa8100;color:white;padding:10px;">Higher Exam</span> &nbsp;&nbsp;&nbsp;&nbsp;</p>
    </div>
    <div class="col-md-4 col-xs-6">
        ...
        <div class="col-md-5 col-xs-5">
            <div class="winners"><p style="text-align:center;color:white;padding-top:35px;"><?php if(isset($next_board_following_user)){echo $next_board_following_user;} ?></p></div>
        </div>
    </div>
  ...
  <div class="row">
    <div class="col-md-8 col-xs-8 col-sm-8 col-lg-8 col-md-offset-2" style="padding-left:100px;">
      <ul class="list-group">
        <li class="first_member custom_box_shadow <?php if(isset($common_result[0]['user_name'])){if($common_result[0]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:-30px;left:-2%; width:175px; height:175px; border-radius: 50%;<?php if(isset($common_result[0]['user_name'])){echo 'background-color: #fa8100;';} ?>">
              ...
              <?php 
                ...
                if(isset($common_result[0]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        ...
                        if($next_formatted_common_result_downline[$common_result[0]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[0]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[0]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[0]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[0]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[0]['fourth_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[0]['fourth_board_entrance_t'])
                    //     {
       ...
       <!--  <p style="color:#78909C;" class="img_description_1">
        ...
        <li class="second_member custom_box_shadow <?php if(isset($common_result[14]['user_name'])){if($common_result[14]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[14]['user_name'])){echo 'background-color: #fa8100;';} ?>">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[14]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                         if($next_formatted_common_result_downline[$common_result[14]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[14]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[14]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[14]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[14]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[14]['fourth_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[14]['fourth_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
        ...
        <li class= "third_member  custom_box_shadow <?php if(isset($common_result[13]['user_name'])){if($common_result[13]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[13]['user_name'])){echo 'background-color: #fa8100;';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
              ...
              <?php 
                ...
                if(isset($common_result[13]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[13]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[13]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[13]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[13]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[13]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[13]['fourth_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[13]['fourth_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
        ...
        <li class="fourth_member custom_box_shadow <?php if(isset($common_result[12]['user_name'])){if($common_result[12]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[12]['user_name'])){echo 'background-color: #fa8100;';} ?>">
          <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[12]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[12]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[12]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[12]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[12]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[12]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[12]['fourth_board_entrance_t'])
                        {
                    ...
                    // {
                    //     // if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[12]['fourth_board_entrance_t'])
                    //     // {
        ...
        <li class="fifth_member custom_box_shadow <?php if(isset($common_result[11]['user_name'])){if($common_result[11]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[11]['user_name'])){echo 'background-color: #fa8100;';} ?>">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[11]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[11]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[11]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[11]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[11]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[11]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[11]['fourth_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[11]['fourth_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
        ...
        <li class="sixth_member custom_box_shadow <?php if(isset($common_result[10]['user_name'])){if($common_result[10]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[10]['user_name'])){echo 'background-color: #fa8100;';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
              ...
              <?php 
                ...
                if(isset($common_result[10]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[10]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[10]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[10]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[10]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[10]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[10]['fourth_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[10]['fourth_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
        ...
        <li class="seventh_member custom_box_shadow <?php if(isset($common_result[9]['user_name'])){if($common_result[9]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[9]['user_name'])){echo 'background-color: #fa8100;';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
              ...
              <?php 
                ...
                if(isset($common_result[9]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[9]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[9]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[9]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[9]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[9]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[9]['fourth_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[9]['fourth_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
        ...
        <li class="eight_member custom_box_shadow <?php if(isset($common_result[8]['user_name'])){if($common_result[8]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[8]['user_name'])){echo 'background-color: #fa8100;';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[8]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                         if($next_formatted_common_result_downline[$common_result[8]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[8]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[8]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[8]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[8]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[8]['fourth_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[8]['fourth_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
        ...
        <li class="nine_member custom_box_shadow <?php if(isset($common_result[7]['user_name'])){if($common_result[7]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[7]['user_name'])){echo 'background-color: #fa8100;';} ?>">  
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
              ...
              <?php 
                ...
                if(isset($common_result[7]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[7]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[7]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[7]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[7]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[7]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[7]['fourth_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[7]['fourth_board_entrance_t'])
                    //     {
                    //          if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
        ...
        <li class="ten_member custom_box_shadow <?php if(isset($common_result[6]['user_name'])){if($common_result[6]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[6]['user_name'])){echo 'background-color: #fa8100;';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[6]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[6]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[6]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[6]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[6]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[6]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[6]['fourth_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[6]['fourth_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
        ...
        <li class="eleven_member custom_box_shadow <?php if(isset($common_result[5]['user_name'])){if($common_result[5]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[5]['user_name'])){echo 'background-color: #fa8100;';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[5]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[5]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[5]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[5]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[5]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[5]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[5]['fourth_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[5]['fourth_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
        ...
        <li class="twelve_member custom_box_shadow <?php if(isset($common_result[4]['user_name'])){if($common_result[4]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[4]['user_name'])){echo 'background-color: #fa8100;';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[4]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[4]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[4]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[4]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[4]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[4]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[4]['fourth_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[4]['fourth_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
...
<table class="table table-bordered">
        ...
        <li class="thirteen_member custom_box_shadow <?php if(isset($common_result[3]['user_name'])){if($common_result[3]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[3]['user_name'])){echo 'background-color: #fa8100;';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
            ...
            <?php 
                ...
                if(isset($common_result[3]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[3]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[3]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[3]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[3]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[3]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[3]['fourth_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[3]['fourth_board_entrance_t'])
                    //     {
                    //          if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
        ...
        <li class="fourteen_member custom_box_shadow <?php if(isset($common_result[2]['user_name'])){if($common_result[2]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[2]['user_name'])){echo 'background-color: #fa8100;';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[2]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                         if($next_formatted_common_result_downline[$common_result[2]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[2]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[2]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[2]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[2]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[2]['fourth_board_entrance_t'])
                        {
                    ...
                    // foreach($next_formatted_common_result_downline[$common_result[2]['child_id']] as $index=>$row_next_formatted_common_result_downline)
                    // {
                    //     if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[2]['fourth_board_entrance_t'])
                    //     {
                    //          if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
        ...
        <li class="fifteen_member custom_box_shadow <?php if(isset($common_result[1]['user_name'])){if($common_result[1]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%;width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[1]['user_name'])){echo 'background-color: #fa8100;';} ?>" >
         ...
         <?php 
                ...
                if(isset($common_result[1]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                         if($next_formatted_common_result_downline[$common_result[1]['child_id']][$downward[0]]['fourth_board_entrance_t']>$next_formatted_common_result_downline[$common_result[1]['child_id']][$downward[1]]['fourth_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[1]['child_id']][$first_downward]['fourth_board_entrance_t']>=$common_result[1]['fourth_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[1]['child_id']][$second_downward]['fourth_board_entrance_t']>=$common_result[1]['fourth_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['fourth_board_entrance_t']>=$common_result[1]['fourth_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
...
<?php foreach($formatted_common_result_following_board as $index=>$row_formatted_common_result_following_board){?>
  ...
  <div class="col-md-2" style="padding-bottom:30px !important;">
    <div class="bs-example">
      <div class="card text-center">
          <div class="card-body"  style="width:150px; height:150px;border-radius: 50%;background-color:rgb(164,124,3)">
