...
<?php  //print_r($next_board_following_user_child_id); ?>
<div class="container-fluid">
    <div class="row" style="padding-top:10px;background-color: rgb(164,124,3);">
        <div class="col-md-12 col-xs-12">
            <p style="font-weight:bold;text-align:center;"><span style="color:white;padding:15px;font-size:20px;">Senior Education Certificate</span></p>
        </div>
    </div>
    ...
    <div class="col-md-4 col-xs-6">
       <p style="color:red;font-weight:bold;font-size:16px;">Board:: #<?php echo $common_result[0]['board_status'];?></p>
        <p style="font-weight:bold;font-size:16px;"><span style="background-color: rgb(164,124,3);color:white;padding:10px;">Senior Exam</span> &nbsp;&nbsp;&nbsp;&nbsp;</p>
    </div>
    <div class="col-md-4 col-xs-6">
        <div class="col-md-3 col-xs-5">
            <div class="players">
                <p style="text-align:center;color:white;padding-top:35px;">
                    ...
                    &nbsp;
                    <span style="color:red;font-size:18px;"><?php if($splitted_leader=='s'){echo '*';} ?></span>
        ...
        <div class="col-md-5 col-xs-5">
            <div class="winners">
              <p style="text-align:center;color:white;padding-top:35px;">
                <a href="<?php echo base_url(); ?>index.php/Dashboard/DashboardController/SearchClassroomByUserIDLink/<?php echo $next_board_following_user_child_id; ?>" target="_blank">
  ...
  <div class="row">
    <div class="col-md-8 col-xs-8 col-sm-8 col-lg-8 col-md-offset-2" style="padding-left:100px;">
      <ul class="list-group">
        <li class="first_member custom_box_shadow <?php if(isset($common_result[0]['user_name'])){if($common_result[0]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:-30px;left:-2%; width:175px; height:175px; border-radius: 50%;<?php if(isset($common_result[0]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>">
          ...
          <p class="li_custom_animation" style="text-align:center;color:white;padding-top:45px;">
            ...
            <?php 
                ...
                if(isset($common_result[0]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        ...
                        if($next_formatted_common_result_downline[$common_result[0]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[0]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[0]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[0]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[0]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[0]['third_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[0]['third_board_entrance_t'])
                    //     {
            ...
            <?php if(isset($common_result[0]['user_name'])){echo $common_result[0]['points'];}?>
          </p>
          <?php
            if(isset($common_result[0]['user_name']))
            {
                       ...
                       <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php if(isset($common_result[0]['user_name'])){echo $common_result[0]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[0]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[0]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table>
       ...
       <!--  <p style="color:#78909C;" class="img_description_1">
        ...
        <li class="second_member custom_box_shadow <?php if(isset($common_result[14]['user_name'])){if($common_result[14]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[14]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[14]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                         if($next_formatted_common_result_downline[$common_result[14]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[14]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[14]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[14]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[14]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[14]['third_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[14]['third_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
        ...
        <div class="bs-example img_description_2" style="width:300px;">
              <div class="card text-center">
                  ...
                  <div class="card-body">
                      <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Points</td>
                            <td><?php if(isset($common_result[14]['user_name'])){echo $common_result[14]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[14]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[14]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table
                  </div>
        ...
        <li class= "third_member  custom_box_shadow <?php if(isset($common_result[13]['user_name'])){if($common_result[13]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[13]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[13]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[13]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[13]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[13]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[13]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[13]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[13]['third_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[13]['third_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
                  ...
                  <div class="card-body">
                     <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Points</td>
                            <td><?php if(isset($common_result[13]['user_name'])){echo $common_result[13]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[13]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[13]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table>
                  </div>
        ...
        <li class="fourth_member custom_box_shadow <?php if(isset($common_result[12]['user_name'])){if($common_result[12]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[12]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>">
          <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
              ...
              <?php 
                ...
                if(isset($common_result[12]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[12]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[12]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[12]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[12]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[12]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[12]['third_board_entrance_t'])
                        {
                    ...
                    // {
                    //     // if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[12]['third_board_entrance_t'])
                    //     // {
                  ...
                  <div class="card-body">
                      <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Points</td>
                            <td><?php if(isset($common_result[12]['user_name'])){echo $common_result[12]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[12]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[12]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table>
                  </div>
        ...
        <li class="fifth_member custom_box_shadow <?php if(isset($common_result[11]['user_name'])){if($common_result[11]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[11]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[11]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[11]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[11]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[11]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[11]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[11]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[11]['third_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[11]['third_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
                  ...
                  <div class="card-body">
                     <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Points</td>
                            <td><?php if(isset($common_result[11]['user_name'])){echo $common_result[11]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[11]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[11]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table>
                  </div>
        ...
        <li class="sixth_member custom_box_shadow <?php if(isset($common_result[10]['user_name'])){if($common_result[10]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[10]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[10]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[10]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[10]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[10]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[10]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[10]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[10]['third_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[10]['third_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
                  ...
                  <div class="card-body">
                      <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Points</td>
                            <td><?php if(isset($common_result[10]['user_name'])){echo $common_result[10]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[10]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[10]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table>
                  </div>
        ...
        <li class="seventh_member custom_box_shadow <?php if(isset($common_result[9]['user_name'])){if($common_result[9]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[9]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
              ...
              <?php 
                ...
                if(isset($common_result[9]['user_name']))
                {
                     ...
                     $downward=array();
                    foreach($next_formatted_common_result_downline[$common_result[9]['child_id']] as $index=>$row_next_formatted_common_result_downline)
                    {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[9]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[9]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[9]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[9]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[9]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[9]['third_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[9]['third_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
                  ...
                  <div class="card-body">
                      <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Points</td>
                            <td><?php if(isset($common_result[9]['user_name'])){echo $common_result[9]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[9]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[9]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table>
                  </div>
        ...
        <li class="eight_member custom_box_shadow <?php if(isset($common_result[8]['user_name'])){if($common_result[8]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[8]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[8]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                         if($next_formatted_common_result_downline[$common_result[8]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[8]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[8]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[8]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[8]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[8]['third_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[8]['third_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
                  ...
                  <div class="card-body">
                      <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Points</td>
                            <td><?php if(isset($common_result[8]['user_name'])){echo $common_result[8]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[8]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[8]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table>
                  </div>
        ...
        <li class="nine_member custom_box_shadow <?php if(isset($common_result[7]['user_name'])){if($common_result[7]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[7]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>">  
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[7]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[7]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[7]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[7]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[7]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[7]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[7]['third_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[7]['third_board_entrance_t'])
                    //     {
                    //          if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
                  ...
                  <div class="card-body">
                      <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Points</td>
                            <td><?php if(isset($common_result[7]['user_name'])){echo $common_result[7]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[7]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[7]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table>
                  </div>
        ...
        <li class="ten_member custom_box_shadow <?php if(isset($common_result[6]['user_name'])){if($common_result[6]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[6]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
            ...
            <?php 
                ...
                if(isset($common_result[6]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[6]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[6]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[6]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[6]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[6]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[6]['third_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[6]['third_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
                  ...
                  <div class="card-body">
                      <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Points</td>
                            <td><?php if(isset($common_result[6]['user_name'])){echo $common_result[6]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[6]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[6]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table>
                  </div>
        ...
        <li class="eleven_member custom_box_shadow <?php if(isset($common_result[5]['user_name'])){if($common_result[5]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[5]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[5]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[5]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[5]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[5]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[5]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[5]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[5]['third_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[5]['third_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
                  ...
                  <div class="card-body">
                     <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Points</td>
                            <td><?php if(isset($common_result[5]['user_name'])){echo $common_result[5]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[5]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[5]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table>
                  </div>
        ...
        <li class="twelve_member custom_box_shadow <?php if(isset($common_result[4]['user_name'])){if($common_result[4]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[4]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[4]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[4]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[4]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[4]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[4]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[4]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[4]['third_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[4]['third_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
...
<table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Points</td>
                            <td><?php if(isset($common_result[4]['user_name'])){echo $common_result[4]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[4]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[4]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table>
                  </div>
        ...
        <li class="thirteen_member custom_box_shadow <?php if(isset($common_result[3]['user_name'])){if($common_result[3]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[3]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
            ...
            <?php 
                ...
                if(isset($common_result[3]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                        if($next_formatted_common_result_downline[$common_result[3]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[3]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[3]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[3]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[3]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[3]['third_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[3]['third_board_entrance_t'])
                    //     {
                    //          if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
                  ...
                  <div class="card-body">
                      <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Points</td>
                            <td><?php if(isset($common_result[3]['user_name'])){echo $common_result[3]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[3]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[3]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table>
                  </div>
        ...
        <li class="fourteen_member custom_box_shadow <?php if(isset($common_result[2]['user_name'])){if($common_result[2]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%; width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[2]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>">
        <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
          ...
          <br/>
             ...
             <?php 
                ...
                if(isset($common_result[2]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                         if($next_formatted_common_result_downline[$common_result[2]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[2]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[2]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[2]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[2]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[2]['third_board_entrance_t'])
                        {
                    ...
                    // foreach($next_formatted_common_result_downline[$common_result[2]['child_id']] as $index=>$row_next_formatted_common_result_downline)
                    // {
                    //     if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[2]['third_board_entrance_t'])
                    //     {
                    //          if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
        ...
        <?php
          ...
          {
        ?>
        <div class="bs-example img_description_14 bg-info" style="width:300px;background: #d9edf7;">
              <div class="card text-center">
                  ...
                  <div class="card-body">
                      <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Points</td>
                            <td><?php if(isset($common_result[2]['user_name'])){echo $common_result[2]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[2]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[2]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table>
                  </div>
        ...
        <li class="fifteen_member custom_box_shadow <?php if(isset($common_result[1]['user_name'])){if($common_result[1]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:5px;left:3%;width:115px; height:115px;border-radius: 50%;<?php if(isset($common_result[1]['user_name'])){echo 'background-color: rgb(164,124,3);';} ?>" >
          ...
          <p class="li_custom_animation" style="text-align:center;color:white;padding-top:22px;">
            ...
            <?php 
                ...
                if(isset($common_result[1]['user_name']))
                {
                    ...
                    if(isset($downward[0]) && isset($downward[1]))
                    {
                         if($next_formatted_common_result_downline[$common_result[1]['child_id']][$downward[0]]['third_board_entrance_t']>$next_formatted_common_result_downline[$common_result[1]['child_id']][$downward[1]]['third_board_entrance_t'])
                        {
                            $second_downward=$downward[0];
                            $first_downward=$downward[1];
                        }
                        ...
                        if($next_formatted_common_result_downline[$common_result[1]['child_id']][$first_downward]['third_board_entrance_t']>=$common_result[1]['third_board_entrance_t'])
                        {
                        ...
                        if($next_formatted_common_result_downline[$common_result[1]['child_id']][$second_downward]['third_board_entrance_t']>=$common_result[1]['third_board_entrance_t'])
                        {
                    ...
                    // {
                    //     if($row_next_formatted_common_result_downline['third_board_entrance_t']>=$common_result[1]['third_board_entrance_t'])
                    //     {
                    //         if($row_next_formatted_common_result_downline['status']=='s')
                    //         {
                    //             echo $row_next_formatted_common_result_downline['user_name'].' *'.'<br/>';
            ...
            ?>
            <?php if(isset($common_result[1]['user_name'])){echo $common_result[1]['points'];}?>
          </p>
                  ...
                  <div class="card-body">
                      <table class="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Points</td>
                            <td><?php if(isset($common_result[1]['user_name'])){echo $common_result[1]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td><?php echo $formatted_common_result[$common_result[1]['child_id']]['total_coins'];?></td>
                          </tr>
                          <tr>
                            <td>Entrance Time</td>
                            <td><?php echo $formatted_common_result[$common_result[1]['child_id']]['third_board_entrance_t'];?></td>
                          </tr>
                        </tbody>
                      </table>
                  </div>
...
<?php foreach($formatted_common_result_following_board as $index=>$row_formatted_common_result_following_board){?>
  ...
  <div class="col-md-2" style="padding-bottom:30px !important;">
    <div class="bs-example">
      <div class="card text-center">
          <div class="card-body"  style="width:150px; height:150px;border-radius: 50%;background-color:rgb(109,110,130)">
              ...
              if(isset($formatted_following_child_board_exp[$row_row_row_formatted_common_result_following_board['child_id']]))
              {
                  foreach($formatted_following_child_board_exp[$row_row_row_formatted_common_result_following_board['child_id']] as $exp_following_id)
                  {
                    ...
                    {
                        echo '<span style="font-size:12px;">'.$exp_following_id['user_name'].'</span>'.'<br/>';
                    }
...
<!--<div class="col-md-12">-->
<!--    <p style="background-color: rgb(164,124,3);text-align:center;color:white;font-weight:bold;font-size:16px;padding-top:25px;padding-bottom:25px;">&copy; Copyright 2021 by PathshalaGlobal. All Rights reserved.</p>-->
<!--</div>-->
