...
<div class="row" style="padding-left:0px !important;padding-right:0px !important;margin-left:0px !important;margin-right:0px !important;">
    ...
    <?php if(isset($board_member[0]['user_name'])){?>
      <li class="sun"><a href="#sun"><span><?php echo $board_member[0]['user_name']; ?></span></a></li>
    <?php } ?>
    <?php if(isset($board_member[1]['user_name'])){ ?>
      <li class="mercury"><a href="#mercury"><span><?php echo $board_member[1]['user_name']; ?></span></a></li>
    <?php } ?>
    <?php if(isset($board_member[2]['user_name'])){ ?>
      <li class="mercury1"><a href="#mercury1"><span><?php echo $board_member[2]['user_name']; ?></span></a></li>
    <?php } ?>
    <?php if(isset($board_member[3]['user_name'])){ ?>
      <li class="venus"><a href="#venus"><span><?php echo $board_member[3]['user_name']; ?></span></a></li>
    <?php } ?>
    <?php if(isset($board_member[4]['user_name'])){ ?>
      <li class="venus1"><a href="#venus1"><span><?php echo $board_member[4]['user_name']; ?></span></a></li>
    <?php } ?>
    <?php if(isset($board_member[5]['user_name'])){ ?>
      <li class="venus2"><a href="#venus2"><span><?php echo $board_member[5]['user_name']; ?></span></a></li>
    <?php } ?>
    <?php if(isset($board_member[6]['user_name'])){ ?>
      <li class="venus3"><a href="#venus3"><span><?php echo $board_member[6]['user_name']; ?></span></a></li>
    <?php } ?>
    <?php if(isset($common_result[0]['user_name'])){ ?>
      <li class="earth"><a href="#earth"><span><?php if(isset($common_result[0]['user_name'])){echo $common_result[0]['user_name'];} ?></span></a></li>
    <?php } ?>
    <?php if(isset($common_result[1]['user_name'])){ ?>
      <li class="earth1"><a href="#earth1"><span><?php if(isset($common_result[1]['user_name'])){echo $common_result[1]['user_name'];} ?></span></a></li>
    <?php } ?>
    <?php if(isset($common_result[2]['user_name'])){ ?>  
      <li class="earth2"><a href="#earth2"><span><?php if(isset($common_result[2]['user_name'])){echo $common_result[2]['user_name'];} ?></span></a></li>
    <?php } ?>
    <?php if(isset($common_result[3]['user_name'])){ ?> 
      <li class="earth3"><a href="#earth3"><span><?php if(isset($common_result[3]['user_name'])){echo $common_result[3]['user_name'];} ?></span></a></li>
    <?php } ?>
    <?php if(isset($common_result[4]['user_name'])){ ?> 
      <li class="earth4"><a href="#earth4"><span><?php if(isset($common_result[4]['user_name'])){echo $common_result[4]['user_name'];} ?></span></a></li>
    <?php } ?>
    <?php if(isset($common_result[5]['user_name'])){ ?>
      <li class="earth5"><a href="#earth5"><span><?php if(isset($common_result[5]['user_name'])){echo $common_result[5]['user_name'];} ?></span></a></li>
    <?php } ?>
    <?php if(isset($common_result[6]['user_name'])){ ?>
      <li class="earth6"><a href="#earth6"><span><?php if(isset($common_result[6]['user_name'])){echo $common_result[6]['user_name'];} ?></span></a></li>
    <?php } ?>
    <?php if(isset($common_result[7]['user_name'])){ ?>
      <li class="earth7"><a href="#earth7"><span><?php if(isset($common_result[7]['user_name'])){echo $common_result[7]['user_name'];} ?></span></a></li>
    <?php } ?>
    </ul>
    ...
    <ul id="descriptions">
        <?php if(isset($board_member[0]['user_name'])){?>
        <li>
        <h2 style="color:#f04941" id="<?php echo $board_member[0]['user_name'];?>"><?php echo $board_member[0]['user_name']; ?></h2>
        <p style="color:#f04941"><?php echo $board_member[0]['user_name']; ?></p>
        </li>
        <?php } ?>
        <?php if(isset($board_member[1]['user_name'])){?>
        <li>
        <h2 style="color:#e52d91" id="<?php echo $board_member[1]['user_name'];?>"><?php echo $board_member[1]['user_name']; ?></h2>
        <p style="color:#e52d91"><?php echo $board_member[1]['user_name']; ?></p>
        </li>
        <?php } ?>
        <?php if(isset($board_member[2]['user_name'])){?>
        <li>
        <h2 style="color:#69bf3a" id="<?php echo $board_member[2]['user_name'];?>"><?php echo $board_member[2]['user_name']; ?></h2>
        <p style="color:#69bf3a"><?php echo $board_member[2]['user_name']; ?></p>
        </li>
        <?php } ?>
        <?php if(isset($board_member[3]['user_name'])){?>
        <li>
        <h2 style="color:#36b871" id="<?php echo $board_member[3]['user_name'];?>"><?php echo $board_member[3]['user_name']; ?></h2>
        <p style="color:#36b871"><?php echo $board_member[3]['user_name']; ?></p>
        </li>
        <?php } ?>
        <?php if(isset($board_member[4]['user_name'])){?>
        <li>
        <h2 style="color:#2ab7c0" id="<?php echo $board_member[4]['user_name'];?>"><?php echo $board_member[4]['user_name']; ?></h2>
        <p style="color:#2ab7c0"><?php echo $board_member[4]['user_name']; ?></p>
        </li>
        <?php } ?>
        <?php if(isset($board_member[5]['user_name'])){?>
        <li>
        <h2 style="color:#45aad3" id="<?php echo $board_member[5]['user_name'];?>"><?php echo $board_member[5]['user_name']; ?></h2>
        <p style="color:#45aad3"><?php echo $board_member[5]['user_name']; ?></p>
        </li>
        <?php } ?>
        <?php if(isset($board_member[6]['user_name'])){?>
        <li>
        <h2 style="color:#9c34a6"style="color:#f04941" id="<?php echo $board_member[6]['user_name'];?>"><?php echo $board_member[6]['user_name']; ?></h2>
        <p style="color:#9c34a6"><?php echo $board_member[6]['user_name']; ?></p>
        </li>
        <?php } ?>
        <?php 
