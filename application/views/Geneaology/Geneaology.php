...
<head>
	...
	<!-- Treeview css -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>files/bower_components/jstree/dist/themes/default/style.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>files/assets/pages/treeview/treeview.css">
    <!-- Style.css -->
                    ...
                    <div class="navbar-container">
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="<?php echo base_url();?>files/assets/images/avatar-4.jpg" class="img-radius"
                    ...
                    <nav class="pcoded-navbar">
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="">
                                    <a href="<?php echo base_url();?>files/extra-pages/landingpage/index.html" target="_blank">
                                ...
                                <li class="pcoded-hasmenu ">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="pcoded-hasmenu ">
                                            ...
                                            <ul class="pcoded-submenu">
                                                <li class="">
                                                    <a href="<?php echo base_url();?>files/extra-pages/email-templates/email-welcome.html">
                                                        <span class="pcoded-mtext">Welcome Email</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="<?php echo base_url();?>files/extra-pages/email-templates/email-password.html">
                                                        <span class="pcoded-mtext">Reset Password</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a
                                                        href="<?php echo base_url();?>files/extra-pages/email-templates/email-newsletter.html">
                                                        <span class="pcoded-mtext">Newsletter Email</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="<?php echo base_url();?>files/extra-pages/email-templates/email-launch.html">
                                                        <span class="pcoded-mtext">App Launch</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a
                                                        href="<?php echo base_url();?>files/extra-pages/email-templates/email-activation.html">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Basic Components</a>
                                                        </li>
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Tabs</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-xl-12">
                                                                <div class="sub-title">Genealogy</div>
                                                                <!-- Nav tabs -->
                                                ...
                                                <div class="card">
														<div class="card-header">
															<h5>Enter The Member Name</h5>
																	...
																	class="form-control form-txt-default"
															placeholder="">
                                                                    <!-- <input type="hidden" name="search_downline" value="1"> -->
																	</div> 
...
<!-- Tree view js -->
    <script type="text/javascript" src="<?php echo base_url();?>files/bower_components/jstree/dist/jstree.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>files/assets/pages/treeview/jquery.tree.js"></script>
