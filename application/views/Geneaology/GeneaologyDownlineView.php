            ...
            <div class="row">
                <div class="col-lg-12 col-xl-12">
                    ...
                    <div class="tab-content tabs card-block">
                        ...
                        <div class="tab-pane show active" id="SearchDownline" role="tabpanel">
                            <div class="row">
                                <div class="col-sm-12 col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <input type="hidden" name="myUserName" value="<?php echo $currentUserName;?>">
                                        ...
                                        <div class="card-block">
                                            <div class="card-block tree-view">
                                                <p style="font-weight:bold;font-size:16px;color:red;">Down Line Of <?php echo $user_name;?></p>

                                                <?php
                                                //echo json_encode($treeData[$user_name]);
                                                get_instance()->load->helper('common_helper');
                                                //echo drawTree($treeData[$user_name])?>
                                                ...
                                                <div id="basicTree">
                                                    ...
                                                    <ul>
                                                        <?php
                                                        foreach($parent_wise_common_result as $index=>$row_parent_wise_common_result){
                                                            ?>
                                                            
                                                            <li data-jstree='{"opened":true}'><?php echo $parent_result[$index]['user_name'];?>
                                                                
                                                                <ul>
                                                                    <?php foreach($row_parent_wise_common_result as $row_item){?>
                                                                            
                                                                            <?php if($parent_result[$index]['child_id']==$row_item['child_id']){}else{?>
                                                                            <li
                                                                                data-jstree='{"icon":"zmdi zmdi-format-underlined"}' data-jstree='{"opened":true}'>
                                                                                <?php echo $row_item['user_name'];?>
                                                                            </li>
                                                                            <?php } ?>
