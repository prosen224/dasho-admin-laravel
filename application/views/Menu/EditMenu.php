    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header text-center" style="background-color:green;padding:20px;margin-bottom:15px;">
                <h5><span style="color:white;font-weight:bold;font-size:16px;">Edit Menu</span></h5>
            </div>
            <div class="card-block" style="padding-left:40px;padding-right:40px;">
                <form action="<?php echo base_url('UpdateMenu');?>" method="post" enctype=multipart/form-data>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="name"
                                id="name" required="required" value="<?php echo $menu_list['name'];?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="number" class="form-control"
                                id="ordering" name="ordering" value="<?php echo $menu_list['ordering'];?>" required="required">
                            <span class="messages"></span>
                        </div>
                    </div>
                    <h4 class="sub-title">Task List</h4>
                    <div class="row">
                        <?php foreach($task_list as $row){?>
                        <div class="col-md-4">
                            <div class="checkbox-fade fade-in-success">
                                <label>
                                    <input type="checkbox" name="items[]" <?php if(isset($menu_details_id[$row['id']])){echo 'checked';}?> value="<?php echo $row['id']?>">
                                    <span class="cr">
                    ...
                    <input type="hidden" name="id" value="<?php echo $menu_list['id'];?>" required="required">
