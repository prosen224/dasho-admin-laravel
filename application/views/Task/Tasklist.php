...
<!-- <div class="row"> -->
    <div class="col-sm-12" style="position: center;">
        <div class="card">
            ...
            <div style="margin:10px;" class="panel-body">
              <a href="<?php echo base_url('AddTask');?>" class="print_button btn btn-primary waves-effect waves-light">Add Task<span style="color:red; font-weight:bold;font-size: 16px;">+</span> </a>
                    ...
                    <table class="table table-bordered" style="padding:15px !important;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <a href="<?php echo base_url();?>Task/TaskController/edit_by_id/<?php echo $row['id'];?>" class="ti-button ti-button-bg btn btn_list btn-info">
                                        <span>Edit</span>
                                    </a>
                                </td>
                            </tr>
