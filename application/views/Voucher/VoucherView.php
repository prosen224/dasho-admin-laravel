...
;"> 
                                        ...
                                        <div class="card-block table-border-style">
	                                        <div class="table-responsive">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td scope="row"><?php echo $Data["voucher_no"]; ?>
                                                        </th>
                                                        ...
                                                        <td style = "color:green">
                                                            <?=($Data["userd_on"])?$Data["userd_on"]:"Not used";?>
                                                        </td>
                                                            
                                                        <td style = "color:green">
                                                            <?=  ($Data["used_by"] !=null)?"Registration for ".member_username($Data["used_by"]):'';?>
                                                        </td>   
                            ...
                            <!-- Ending History Portion -->
                                ...
                                <div class="tab-pane" id="PurchaseVouchers" role="tabpanel">
                                  ...
                                  <div class="tab-pane <?php echo $verify_tab;?>" id="VerifyVouchers" role="tabpanel">
                                          ...
                                          <h5 class="center" style = "color:green;font-weight:bold;">Verify Vouchers</h5>
                                      <br>
                                    <div class="row showVoucherForm" id="TPBox2" style = "<?php echo $hideStyle?>">
                                        <div class="col-md-6">
                                    ...
                                    <div class = "row" id = "voucherDetails">
                                        <div class = "col-md-8 offset-md-2 p-3" style = "border:2px; background-color:#DDF4E9;">
                                        <p>Voucher NO: <?php echo $voucher_data[0]->voucher_no; ?></p>
                                            ...
                                            echo  $newDate; ?></p>
                                            <p>Voucher Owner: <?= member_username($voucher_data[0]->created_by) ?> &rarr;  <button id = "OwnerInfoButton" class="badge badge-primary"> View Details</button></p>
                                            <?php if($voucher_data[0]->used_by):  ?>
                                            <p>Used On:  <?php echo $voucher_data[0]->userd_on; ?> </p>
                                            <p>Used for: <?= ($voucher_data[0]->used_by)?member_username($voucher_data[0]->used_by):'' ; ?>
                                            &rarr; <button id = "CustomerInfoButton" class="badge badge-primary"> View Details</button>
                                            <?php endif; ?>
                                        </p>
                                    ...
                                    <div class = "row" style ="display:none;" id="voucherOwnerData">
                                        ...
                                        <p>User Name: <?php echo $VouchersOwnersData[0]->user_name; ?></p>
                                        ...
                                        <p>First Name: <?php echo $VouchersOwnersData[0]->FirstName; ?></p>
                                        <p>Last Name: <?php echo $VouchersOwnersData[0]->LastName; ?></p>
                                        <p>Address: <?php echo $VouchersOwnersData[0]->street_address; ?></p>
                                        <p>City: <?php echo $VouchersOwnersData[0]->city; ?></p>
                                        <?php if($VouchersOwnersData[0]->postal): ?>
                                        <p>Zip: <?php echo $VouchersOwnersData[0]->postal; ?></p>
                                        <?php endif; ?>
                                        <p>Country: <?php echo $VouchersOwnersData[0]->country; ?></p>
                                        ...
                                        <div class="buttons text-center">
                                            <a href="javascript:void(0)" class="btn btn-primary btn-sm ownerBack">&larr; Back</a>
                                            <a href="javascript:void(0)" class="btn btn-primary btn-sm verifyNew">Verify New Voucher</a>
                                        </div>
                                            
                                        </div>
                                    </div>

                                    <?php if($VouchersUserData): ?>
                                    <div class = "row" style ="display:none;" id="CustomerData">
                                        <div class = "col-md-8 offset-md-2" style = "border:2px; background-color:lightgreen;">
                                        <p>User Name: <?php echo $VouchersUserData[0]->user_name; ?></p>
                                        
                                        <p>Date Of Joining: <?php 
                                            $originalDate = $VouchersUserData[0]->created_at;
                                            $newDate = date("d-M-Y", strtotime($originalDate));

                                            echo  $newDate; ?></p>
                                        <p>First Name: <?php echo $VouchersUserData[0]->FirstName; ?></p>
                                        <p>Last Name: <?php echo $VouchersUserData[0]->LastName; ?></p>
                                        <p>Address: <?php echo $VouchersUserData[0]->street_address; ?></p>
                                        <p>City: <?php echo $VouchersUserData[0]->city; ?></p>
                                        <?php if($VouchersUserData[0]->postal): ?>
                                        <p>Zip: <?php echo $VouchersUserData[0]->postal; ?></p>
                                        <?php endif; ?>
                                        <p>Country: <?php echo $VouchersUserData[0]->country; ?></p>
                                      
                                        <p>Rank: <?php
                                          switch($VouchersUserData[0]->rank):
                                                case "First Class":
                                                    $rank = "Primary Associate";
                                                    break;
                                                case "Second Class":
                                            ...
                                            echo $rank; ?></p>
                                             <div class="buttons text-center">
                                                <a href="javascript:void(0)" class="btn btn-primary btn-sm memberBack">&larr; Back</a>
                                                <a href="javascript:void(0)" class="btn btn-primary btn-sm verifyNew">Verify New Voucher</a>
                                            </div>
 ...
 <script src="<?php echo base_url(); ?>website_assets/js/vendor.min.js"></script>
  ...
  $(document).ready(function() {
    ...
    $('.ownerBack').click(function() {
        $('#voucherDetails').show();
        $('#voucherOwnerData').hide();
    });

    $('#CustomerInfoButton').click(function() {
        $('#voucherDetails').hide();
        $('#CustomerData').show();
        
    });

    $('.memberBack').click(function() {
        $('#voucherDetails').show();
        $('#CustomerData').hide();
    ...
    $('.verifyNew').click(function() {
        ...
        // $("#TPBox2").attr("style", "display:block");
        $(".showVoucherForm").removeAttr('style');
