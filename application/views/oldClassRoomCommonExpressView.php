      ...
      <ul class="list-group">
        <li class="first_member custom_box_shadow <?php if(isset($common_result[0]['user_name'])){if($common_result[0]['user_name']==$own_user_name['user_name']){echo 'blink_me';} }?>" style="top:-30px;left:-2%; width:175px; height:175px; border-radius: 50%;<?php if(isset($common_result[0]['user_name'])){echo 'background-color:rgb(109,110,130)';} ?>">
          ...
          <p class="li_custom_animation" style="text-align:center;color:white;padding-top:45px;">
            ...
            <br/>
              ...
              <?php 
                if(isset($common_result[0]['user_name']))
                {
                   ...
                   $currentLevelDownline = $next_formatted_common_result_downline[$common_result[0]['child_id']];

                   if(is_array($currentLevelDownline) && count($currentLevelDownline) > 0){
                      foreach ($currentLevelDownline as $key => $value) {
                        // echo "<pre>";
                        // print_r($value);
                        print "<span style='font-size:15px;'>".$value['user_name']."</span><br/>";
                      }
                   }
            ...
            <?= get_available_point($common_result[0]["child_id"]);  //if(isset($common_result[0]['user_name'])){echo $common_result[0]['points'];}?>
          </p>
          <?php
            if(isset($common_result[0]['user_name']))
            {
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <?= get_available_point(@$common_result[7]["child_id"]); ?>
                              ...
                              //if(isset($common_result[7]['user_name'])){echo $common_result[7]['points'];}?></td>
                          </tr>
                          <tr>
                            <td>Total Coins</td>
                            <td>
